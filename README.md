...
| --- | --- | --- | --- |
| Owncloud | 9001 | Browser access to owncloud Document by http | Y |
| MySQL | 3306 | Remote access MySQL | N |
## Documentation

[Owncloud Administrator Guide](https://support.websoft9.com/docs/owncloud)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Owncloud Enterprise Support](https://apps.websoft9.com/owncloud) 
